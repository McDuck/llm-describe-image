...
DEFAULT_VIDEO_TRANSCRIPTION_ENABLED: bool = _config["video"]["transcription_enabled"]
DEFAULT_VIDEO_TRANSCRIPTION_BACKEND: str = _config["video"]["transcription_backend"]
DEFAULT_VIDEO_TRANSCRIPTION_MODEL: str = _config["video"]["transcription_model"]
DEFAULT_VIDEO_TRANSCRIPTION_LANGUAGE: str = _config["video"]["transcription_language"]
DEFAULT_VIDEO_DESCRIPTION_PROMPT: str = _config["video"]["description_prompt"]
...
DEFAULT_MAX_CONTEXT_LENGTH: int = _config["enhancement"]["max_context_length"]
