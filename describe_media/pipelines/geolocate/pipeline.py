"""Geolocation Pipeline: Discover â†’ Geolocate â†’ Write"""
...
class GeolocationPipeline(Pipeline):
    ...
    def __init__(self) -> None:
        ...
        self.num_geolocate_threads: int = 1  # Public reverse geocoders must be rate-limited.
    ...
    PIPELINE_CONFIG = [
        ...
        },
        {
            ...
            "kwargs_builder": lambda self: {
                ...
                "output_suffix_pattern": "{ext}.geocode.txt",
        ...
        },
        {
            ...
            "kwargs_builder": lambda self: {
                ...
                "max_retries": 5,
                "timeout_seconds": int(os.getenv("GEOLOCATE_TIMEOUT_S", "30")),
            },
            "task": "Geolocate",
